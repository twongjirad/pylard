...
# This contains the data type the opdet display panel uses for its waveforms
# There is also a container class as well which provides some convenience functions
...
class OpWfmPlotVector:
    ...
    def addWindow( self, cdw ):
        # cdw are cosmic discriminator window objects
